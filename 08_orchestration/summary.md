...
- DAG 模型：用有向无环图表示任务依赖
- Claude Code 的 7 种 Task 类型：local_bash、local_agent、remote_agent、in_process_teammate、workflow、monitor_mcp、dream
