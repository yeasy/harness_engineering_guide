...
**来源**：Princeton University（发表于 ICLR 2024；OpenAI 后续合作推出 SWE-bench Verified，由 OpenAI Preparedness 团队于 2024 年 8 月发布，含 500 个经过人工验证的 issue-PR 对，从 SWE-Bench 原始 2294 个任务中精选）

**特点**：

- 2,294个真实GitHub问题（Verified版本：500个经人工验证的高质量子集）
- 需要修改代码、运行测试
- 评估代码理解与修改能力
