...
from mini_harness.models import ClaudeProvider, ModelConfig
from mini_harness.tools import ToolRegistry

# 初始化组件
config = ModelConfig(api_key="sk-...", model="claude-sonnet-4-20250514")
...
```python
# 示例:注册自定义工具
from mini_harness.core import Tool
from mini_harness.tools import ToolRegistry
