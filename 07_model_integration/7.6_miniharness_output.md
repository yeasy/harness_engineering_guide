...
[结构验证] — ID、名称字段完整？
    ↓
[Schema 验证] — 参数符合 Pydantic schema？
    ↓
[执行] 或 [拒绝 + 建议]
...
from mini_harness.models.quality import ToolRegistry, QualityGate
