...
| 向量库 | 许可证 | 适用规模 | 2026 状态 |
|--------|--------|---------|----------|
| **Hnswlib** | 商用友好 | <1M 向量 | 轻量级、内存索引、无操作成本 |
| **Qdrant** | 开源(AGPL/商业) | 1M-10M 向量 | Rust 性能、完整 API、支持自托管 |
| **pgvector** | 开源(PostgreSQL扩展) | <5M 向量 | 集成关系数据库、SQL 查询、成本低 |
| **Weaviate** | 开源/商业 | 10M+ 向量 | 知识图谱+向量混合、企业部署选项 |
