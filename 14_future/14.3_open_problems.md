...
现有 Agent 使用的上下文窗口虽已扩展至 200K-1M tokens 量级（截至 2026-05-16，Anthropic 官方[能力表](https://docs.anthropic.com/en/docs/build-with-claude/context-windows)中 Claude Sonnet 4.6、Opus 4.6/4.7 等属于 1M 级窗口；不同模型和凭据资格仍需按官方目录确认），但仍然是有限的短期窗口。 **如何让智能体维持长期记忆并在多天/月的时间尺度上保持目标？**
